<template>
  <div class="min-h-screen flex flex-col">
    ...
    <footer class="bg-secondary text-gray-400 py-8 text-center text-sm mt-auto">
      <div class="max-w-7xl mx-auto px-4 flex flex-col items-center">
        <!-- Redes Sociales -->
        <h3 class="text-white text-lg font-semibold mb-4">Síguenos en nuestras redes</h3>
        <div class="flex space-x-6 mb-6">
          <a href="https://www.facebook.com/profile.php?id=61585201206673" target="_blank" rel="noopener noreferrer" class="text-gray-400 hover:text-accent transition-colors" aria-label="Facebook">
            <svg class="h-8 w-8" fill="currentColor" viewBox="0 0 24 24" aria-hidden="true">
              <path fill-rule="evenodd" d="M22 12c0-5.523-4.477-10-10-10S2 6.477 2 12c0 4.991 3.657 9.128 8.438 9.878v-6.987h-2.54V12h2.54V9.797c0-2.506 1.492-3.89 3.777-3.89 1.094 0 2.238.195 2.238.195v2.46h-1.26c-1.243 0-1.63.771-1.63 1.562V12h2.773l-.443 2.89h-2.33v6.988C18.343 21.128 22 16.991 22 12z" clip-rule="evenodd" />
            </svg>
          </a>
          <a href="https://www.instagram.com/la_chispa_sur" target="_blank" rel="noopener noreferrer" class="text-gray-400 hover:text-accent transition-colors" aria-label="Instagram">
            <svg class="h-8 w-8" fill="currentColor" viewBox="0 0 24 24" aria-hidden="true">
